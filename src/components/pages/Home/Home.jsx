              ...
              {listTreeCards.map((car) => (
                ...
                >
                  ...
                  <div className="card-cars-info">
                    ...
                    <p className="card-cars-price">Prix : {car.price} Euros</p>
                  </div>
                  <Button
          ...
          <Row>
            ...
            <Col xs={12} md={6} xl={4} className="wrapper-skills ">
              <div>
                <img
                  ...
                  alt="Avatar"
                />
                <p className="h-line titleAvatar">V. Parrot agréé assurances</p>
                <p className="v-line description">
                  Notre garage est agréé toutes assurances. Nous vous offrons la
                  franchise et mettons à votre disposition un véhicule de prêt.
                </p>
              </div>
            ...
            <Col xs={12} md={6} xl={4} className="wrapper-skills">
              <div>
                ...
                <p className="v-line description">
                  Notre garage mécanique effectue toutes vos réparations et vos
                  travaux d’entretien.
                </p>
              </div>
              <div class="wrapper-skills ">
